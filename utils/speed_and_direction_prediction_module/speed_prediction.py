...
def predict_speed(
    ...
    if len(bottom_position_of_detected_vehicle) != 0 and bottom \
        - bottom_position_of_detected_vehicle[0] > 0 and 205 < bottom_position_of_detected_vehicle[0] < 210 \
    ...
    if isInROI:
        ...
        # multiplied by 44 to convert pixel length to real length in meters
